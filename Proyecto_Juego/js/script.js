...
// variables de las acciones del juego
var score = 0;
var scoreText;
var gameOver= false;
var saltoa;
...
// se crean las plataformas 
    ...
    player.setScale(1.5);
// se crea el movimiento del personaje izq
    this.anims.create({
        key: 'left',
...
// se crea el movimiento del personaje quieto
    this.anims.create({
        key: 'turn',
...
// se crea el movimiento del personaje derecha
    this.anims.create({
        key: 'right',
    ...
    // player.body.setGravityY(300);// es 

    this.physics.add.collider(player, platforms);

    cursors = this.input.keyboard.createCursorKeys();// manda a llama los controles-teclas 
// fisica de los tacos  hace aparecer 11
...
// fisica de las bombas
    this.physics.add.collider(stars, platforms);

    this.physics.add.overlap(player, stars, collectStar, null, true);

    scoreText = this.add.text(16, 16, 'Tacos: 0', {fontSize: '32px', fill: '#ffffff'});// es el tamaño de el puntaje
...
// son los comandos para mandar a llamarlas animaciones y controles
function update(){
